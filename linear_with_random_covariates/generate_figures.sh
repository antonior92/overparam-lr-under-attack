...
python plot_double_descent.py --file results/isotropic-gaussian-prior.csv --save figures/isotropic-gaussian-prior-l1.5.png --plot_style $STYLE ../one_third_with_ylabel.mplsty --ord 1.5 --y_min -0.2 --y_max 4.99
python plot_double_descent.py --file results/isotropic-gaussian-prior.csv --save figures/isotropic-gaussian-prior-l2.png --plot_style $STYLE ../one_third_without_ylabel.mplsty --remove_ylabel --remove_legend --ord 2 --y_min -0.2 --y_max 4.99
python plot_double_descent.py --file results/isotropic-gaussian-prior.csv --save figures/isotropic-gaussian-prior-l20.png --plot_style $STYLE ../one_third_without_ylabel.mplsty  --remove_ylabel --remove_legend --ord 20 --y_min -0.2 --y_max 4.99
